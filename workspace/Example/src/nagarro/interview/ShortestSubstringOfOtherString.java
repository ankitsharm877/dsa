package nagarro.interview;

public class ShortestSubstringOfOtherString {

	public static void main(String[] args) {
		String str = "this is a test string", pattern = "tist" ;
		System.out.println(findSmallestSubstring(str, pattern));
	}

	static String findSmallestSubstring(String str, String pat) {
        int len1 = str.length();
        int len2 = pat.length();
        if (len1 < len2) {
